/*
  ==============================================================================
    ...
    DelayedMehndi.cpp
    Created: 29 April 2023 8:57:12pm
    Author:  ashay

  ==============================================================================
*/

#include "DelayedMehndi.h"

Ashay::DelayedMehndi::DelayedMehndi(): delayBuffer(2,1)
{
    delayLength = 0.5f;
    dryMix = 1.0f;
    wetMix = 0.5f;
...
Ashay::DelayedMehndi::~DelayedMehndi()
{
}

void Ashay::DelayedMehndi::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void Ashay::DelayedMehndi::process(juce::AudioBuffer<float>& buffer, float delayLengthParameter, float dryWetParameter, float feedbackParameter)
{
...
void Ashay::DelayedMehndi::reset()
{
    delayBuffer.clear();
}
